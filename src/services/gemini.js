...
export const generateFastVisualConcept = async (inputs) => {
  return retryOperation(async () => {
    ...
    **核心任务：分析【特质】与【歌曲暗示】，决定替身的形态与外貌。**

    ⚠️ **重要指令：形态多样性平衡**
    - 在JOJO世界中，**“人形/半人形”是绝对主流 (占60%以上)**，如白金之星、疯狂钻石、黄金体验、石之自由。
    - **不要**仅仅因为特质抽象就设计成“群体”或“现象”。只有当特质极其适合(如“增殖”、“搜集”、“微操”)时，才使用**群体型**。
    - **器物/机械型** (如皇帝、史密斯飞船) 适合“工具性”或“精准”特质。
    - **近距离力量型 (人形)** 适合绝大多数直接、强烈、守护或破坏的特质。**请优先通过独特的人形设计来表达特质！**
